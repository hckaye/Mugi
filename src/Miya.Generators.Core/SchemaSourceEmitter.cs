...
internal sealed class SchemaSourceEmitter
{
    ...
    private void EmitBind(CodeWriter writer)
    {
        ...
        writer.Open(
            "public async global::System.Threading.Tasks.ValueTask<global::Miya.Schema.BindResult<" +
            inputName + ">> Bind(global::Miya.Context context)");
        writer.Line("var errors = new global::System.Collections.Generic.List<global::Miya.Schema.ValidationError>();");
        ...
        if (_model.Fields.Any(static field => field.Source == SchemaFieldSource.Body))
        {
            ...
            writer.Close();
            writer.Open("catch (global::Miya.Json.JsonException exception) when (exception.IsInputError)");
            writer.Line("errors.Add(new global::Miya.Schema.ValidationError(\"body\", \"invalid JSON body\"));");
        ...
        writer.Line("return global::Miya.Schema.BindResult<" + inputName + ">.Valid(value);");
        writer.Close();
    }
    ...
    private static void EmitErrorResponse(CodeWriter writer)
    {
        writer.Open(
            ...
            "global::Miya.Context context, " +
            "global::System.Collections.Generic.IReadOnlyList<global::Miya.Schema.ValidationError> errors)");
        writer.Line("context.Status(400);");
        writer.Line("var buffer = new global::System.Buffers.ArrayBufferWriter<byte>();");
        writer.Line(
            "global::Miya.Json.Json.Serialize(buffer, new ErrorResponse(errors), ErrorResponseCodec.Instance);");
        ...
        writer.Open(
            ...
            "global::Miya.Json.IJsonCodec<ErrorResponse>");
        writer.Line("internal static readonly ErrorResponseCodec Instance = new ErrorResponseCodec();");
        writer.Line();
        writer.Open(
            "public void Write(ref global::Miya.Json.JsonWriter writer, ErrorResponse? value)");
        ...
        writer.Line();
        writer.Open(
            "public ErrorResponse? Read(ref global::Miya.Json.JsonReader reader)");
        writer.Line(
    ...
    {
        writer.Open("internal sealed class BodyValuesCodec : global::Miya.Json.IJsonCodec<BodyValues>");
        writer.Line("internal static readonly BodyValuesCodec Instance = new BodyValuesCodec();");
        writer.Line();
        writer.Open("public void Write(ref global::Miya.Json.JsonWriter writer, BodyValues? value)");
        writer.Line("throw new global::System.NotSupportedException(\"Schema body values are read-only.\");");
        writer.Close();
        writer.Line();
        writer.Open("public BodyValues? Read(ref global::Miya.Json.JsonReader reader)");
        ...
        foreach (var item in bodyFields)
        {
            ...
            writer.Line(
                "result.Value" + item.Index + " = global::Miya.Json.Json.GetCodec<" +
    ...
    private void EmitRegistration(CodeWriter writer, string binderName)
    {
        ...
        writer.Line(
            "global::Miya.Schema.BinderRegistry<" + TypeNames.NonNullableDisplay(_model.InputType) +
            ">.Register(" + binderName + ".Instance);");
        if (_model.Fields.Any(static field => field.Source == SchemaFieldSource.Body))
        {
            writer.Line(
                "global::Miya.Json.Json.Register<" + binderName + ".BodyValues>(" +
