...
--------|----------|----------|-------
MIYA006 | Miya.Generators | Error | Unknown Context.Param route parameter
MIYA010 | Miya.Generators | Error | Schema route field missing from pattern
MIYA011 | Miya.Generators | Error | Route parameter missing from input schema
MIYA012 | Miya.Generators | Error | Unsupported schema field type
