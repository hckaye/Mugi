...
namespace Miya.Testing;

/// <summary>
/// A response captured from an in-process <c>App.Request</c> call. Headers include values set by
/// the handler and by Miya's response handling (for example Content-Type and Content-Length).
...
public sealed class TestResponse
{
    ...
    public T? Json<T>()
    {
        ...
        return global::Miya.Json.Json.Deserialize(_body, codec);
    }
