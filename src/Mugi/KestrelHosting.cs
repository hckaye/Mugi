    ...
    where TContext : Context, new()
{
        ...
        CancellationToken ct)
    {
        ...
        // to obtain an IServer, then start Mugi's IHttpApplication directly.
        IHost? host = null;
        try
        {
        ...
        ILoggerFactory loggerFactory)
    {
        ...
        listenOptions.KestrelServerOptions.ApplicationServices = new LoggingServiceProvider(
            applicationServices,
            loggerFactory.CreateLogger("Mugi.Kestrel.ApplicationServices"));
...
/// <summary>
/// Represents a running Mugi Kestrel server.
/// </summary>
