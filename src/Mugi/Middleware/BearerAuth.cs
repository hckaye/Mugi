...
/// token-as-JWT authentication lives in Mugi.Jwt. Failed requests do not call the next handler.
/// </summary>
...
/// <see cref="Validate"/> must be set. JWT-based authentication lives in Mugi.Jwt.
/// </summary>
