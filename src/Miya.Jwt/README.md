...
Miya.Jwt signs and verifies compact JWTs for the [Miya](https://www.nuget.org/packages/Miya) web framework without reflection, so it works under NativeAOT. It supports HS256, RS256, and ES256, and ships an authentication middleware.
