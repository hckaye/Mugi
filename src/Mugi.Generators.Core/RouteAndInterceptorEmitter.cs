...
internal static class RouteAndInterceptorEmitter
{
        ...
        ImmutableArray<JsonTypeModel> models)
    {
        ...
        writer.Open("namespace Mugi.Generated");
        ...
        string suffix)
    {
        ...
        writer.Line(
            ...
            ", global::Mugi.Json.Json.ResolveCodec<" + TypeNames.NonNullableDisplay(typeArgument) + ">(" +
    ...
    {
        writer.Line("internal static readonly global::Mugi.RouteTemplate " + RouteFieldName(route.Pattern) + " =");
        writer.Line("    global::Mugi.RouteTemplate.Precompiled(");
