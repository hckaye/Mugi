...
public static class GeneratorCore
{
        ...
        GeneratorSettings settings)
    {
        ...
        if (orderedModels.Length != 0)
        {
            ...
            sources.Add(new GeneratedSource("Mugi.JsonCodecs.g.cs", jsonEmitter.EmitCodecs()));
            sources.Add(new GeneratedSource("Mugi.JsonRegistration.g.cs", jsonEmitter.EmitRegistration()));
        }

        if (routes.Length != 0)
        {
            sources.Add(new GeneratedSource(
                "Mugi.RouteTemplates.g.cs",
        ...
        {
            sources.Add(new GeneratedSource(
                "Mugi.SchemaBinder." + SchemaSourceEmitter.BinderName(binding.InputType) + ".g.cs",
        ...
        GeneratorSettings settings)
    {
        ...
        return new GeneratedSource(
            "Mugi.Interceptor." + interceptorKey + ".g.cs",
