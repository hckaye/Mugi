...
internal sealed class JsonCodecSourceEmitter
{
    ...
    internal void EmitCodec(CodeWriter writer, IJsonCodecModel model)
    {
        writer.Open(
            ...
            + " : global::Mugi.Json.IJsonCodec<" + model.TypeName + ">");
        writer.Line("internal static readonly " + model.CodecName + " Instance = new " + model.CodecName + "();");
        writer.Line();
        writer.Line(
            "public void Write(ref global::Mugi.Json.JsonWriter writer, " + model.ValueTypeName
            + " value) => WriteValue(ref writer, value);");
        writer.Line(
            "public " + model.ValueTypeName
            + " Read(ref global::Mugi.Json.JsonReader reader) => ReadValue(ref reader, 0);");
        writer.Line();
        writer.Open(
            "internal static void WriteValue(ref global::Mugi.Json.JsonWriter writer, "
        ...
        writer.Open(
            ...
            + " ReadValue(ref global::Mugi.Json.JsonReader reader, int depth)");
    ...
    internal void EmitRegistration(CodeWriter writer, string className)
    {
        ...
        {
            writer.Line(
                "global::Mugi.Json.Json.Register<" + model.TypeName + ">("
    ...
    internal void EmitDeferredRegistration(CodeWriter writer, string className)
    {
        ...
        foreach (var model in _models)
        {
            writer.Line(
                "global::Mugi.Json.Json.Register<" + model.TypeName + ">(" +
                "global::Mugi.Json.Json.ResolveCodec<" + model.TypeName + ">(" +
                model.CodecName + ".Instance));");
        }
    ...
    private static void EmitReadBody(CodeWriter writer, IJsonCodecModel model)
    {
        switch (model.Kind)
        {
            ...
            case JsonTypeKind.Char:
                ...
                writer.Line("throw new global::Mugi.Json.JsonException(\"Expected a single JSON character.\", isInputError: true);");
                writer.Close();
    ...
    private static void EmitReadStringEnum(CodeWriter writer, IJsonCodecModel model)
    {
        ...
        writer.Line(
            "    _ => throw new global::Mugi.Json.JsonException("
    ...
    private static void EmitReadSequence(CodeWriter writer, IJsonCodecModel model)
    {
        ...
        {
            read += " ?? throw new global::Mugi.Json.JsonException("
    ...
    private static void EmitReadObject(CodeWriter writer, IJsonCodecModel model)
    {
        ...
        foreach (var item in required)
        {
            ...
            writer.Line(
                "throw new global::Mugi.Json.JsonException("
