...
public sealed class SchemaPartGeneratorTests
{
    ...
    public void Use_requires_the_concrete_input_to_implement_the_part_type()
    {
        ...
        Assert.DoesNotContain(
            ...
            static diagnostic => diagnostic.Id.StartsWith("MUGI", StringComparison.Ordinal));
    }

    [Fact]
    public void MUGI017_reports_duplicate_part_definitions()
    {
        const string source = """
            using Mugi.Schema;
            internal interface IPaging { int Page { get; } }
    ...
    [Fact]
    public void MUGI018_reports_a_part_declared_in_another_assembly()
    {
    ...
    [Fact]
    public void MUGI019_reports_explicit_interface_implementation()
    {
        const string source = """
            using Mugi.Schema;
            internal interface IPaging { int Page { get; } }
    ...
    [Fact]
    public void MUGI024_reports_a_member_contributed_by_two_parts()
    {
        const string source = """
            using Mugi.Schema;
    ...
    [Fact]
    public void MUGI024_reports_the_same_part_applied_twice()
    {
        const string source = """
            using Mugi.Schema;
            internal interface IPaging { int Page { get; } }
