...
public sealed class GeneratorExecutionTests
{
    ...
    public void Null_conditional_json_call_generates_and_registers_its_codec()
    {
        ...
        Assert.Contains(
            ...
            run.SourcesWithPrefix("Mugi.JsonCodec."),
    ...
    [Fact]
    public void Required_property_missing_throws_mugi_json_exception()
    {
        const string source = """
            using Mugi.Json;
        ...
        var exception = Assert.Throws<TargetInvocationException>(
            () => assembly.GetType("Runner")!.GetMethod("Run")!.Invoke(null, null));
        var jsonException = Assert.IsType<Mugi.Json.JsonException>(exception.InnerException);
    ...
    public void Generated_writer_honors_configured_depth_and_collection_limits()
    {
        ...
        Assert.False(Assert.IsType<Mugi.Json.JsonException>(depth.InnerException).IsInputError);
        Assert.False(Assert.IsType<Mugi.Json.JsonException>(collection.InnerException).IsInputError);
        Assert.False(Assert.IsType<Mugi.Json.JsonException>(array.InnerException).IsInputError);
        Assert.False(Assert.IsType<Mugi.Json.JsonException>(dictionary.InnerException).IsInputError);
    }
    ...
    public void Generated_small_integer_overflow_is_classified_as_input_error()
    {
        ...
        var invocation = Assert.Throws<TargetInvocationException>(
            () => assembly.GetType("Runner")!.GetMethod("Run")!.Invoke(null, null));
        var exception = Assert.IsType<Mugi.Json.JsonException>(invocation.InnerException);
