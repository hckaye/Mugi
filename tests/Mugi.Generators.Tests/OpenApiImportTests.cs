...
public sealed class OpenApiImportTests
{
    ...
    public void Representative_additional_file_generates_dtos_paths_and_schemas()
    {
        ...
        var generated = run.SourcesWithPrefix("Mugi.OpenApi.");
    ...
    public void Unsupported_schema_shapes_and_name_collisions_report_import_diagnostics()
    {
        ...
        Assert.Contains(diagnostics, diagnostic => diagnostic.Id == "MUGI021");
        Assert.Contains(diagnostics, diagnostic => diagnostic.Id == "MUGI022");
        Assert.Contains(diagnostics, diagnostic => diagnostic.Id == "MUGI023");
    }

    [Fact]
    public void Invalid_json_reports_mugi020_without_generating_import_source()
    {
        ...
        Assert.Contains(AllDiagnostics(run), diagnostic => diagnostic.Id == "MUGI020");
    ...
    public void Namespace_defaults_to_the_project_root_namespace()
    {
        ...
        Assert.Contains(
            ...
            run.SourcesWithPrefix("Mugi.OpenApi."),
            StringComparison.Ordinal);
    }
        ...
        string? targetNamespace)
    {
        ...
        {
            values["MugiOpenApiNamespace"] = targetNamespace;
        }
